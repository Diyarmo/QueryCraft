...
1. The primary task description lives in `task.md`. Refer to it to understand the end goal and requirements.
2. `design-doc.md` captures what we aim to achieve and the architectural/technical plan for getting there.
3. `planning.md` is the single source of truth for current progress and the roadmap. 
